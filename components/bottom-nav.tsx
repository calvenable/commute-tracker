...
export default function BottomNav({selectedPage}: {selectedPage: Page}) {
    ...
    return (
        <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-neutral-primary-soft border-t border-default">
            <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                <a href="/home" className="inline-flex flex-col items-center justify-center px-5 hover:bg-neutral-secondary-medium group">
